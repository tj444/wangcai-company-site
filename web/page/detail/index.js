  ...
  return (
    <div className="lottery-detail-box">
      <div className="lottery-issue">
        ...
        <div className="right-content">开奖日期：{moment(moment.unix(open_time)).format('YYYY年MM月DD日')}</div>
      </div>
...
const getSearchParams = search => {
  ...
  pairs.forEach(function (pair) {
    if (pair && pair.indexOf('=') !== -1) {
      pair = pair.split('=');
      //兼容写法
      result[pair[0]] = result[pair[0].toLocaleLowerCase()] = decodeURIComponent(pair[1] || '');
    }
  });
